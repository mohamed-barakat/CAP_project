...
CoproductOnMorphismAndObject := rec(
  filter_list := [ "category", "morphism", "object" ],
  return_type := "morphism",
  input_arguments_names := [ "cat", "alpha", "b" ],
  output_source_getter_string := "BinaryCoproduct( cat, Source( alpha ), b )",
  output_source_getter_preconditions := [ [ "Coproduct", 1 ] ],
  output_range_getter_string := "BinaryCoproduct( cat, Range( alpha ), b )",
  output_range_getter_preconditions := [ [ "Coproduct", 1 ] ],
  with_given_object_position := "both",
  dual_operation := "DirectProductOnMorphismAndObject",
  dual_arguments_reversed := false,
  compatible_with_congruence_of_morphisms := true,
  # Test in MonoidalCategoriesTest
),

CoproductOnMorphismAndObjectWithGivenCoproducts := rec(
  ...
  output_range_getter_string := "r",
  output_range_getter_preconditions := [ ],
  dual_operation := "DirectProductOnMorphismAndObjectWithGivenDirectProducts",
  dual_with_given_objects_reversed := true,
  compatible_with_congruence_of_morphisms := true,
),

CoproductOnObjectAndMorphism := rec(
  filter_list := [ "category", "object", "morphism" ],
  return_type := "morphism",
  input_arguments_names := [ "cat", "a", "beta" ],
  output_source_getter_string := "BinaryCoproduct( cat, a, Source( beta ) )",
  output_source_getter_preconditions := [ [ "Coproduct", 1 ] ],
  output_range_getter_string := "BinaryCoproduct( cat, a, Range( beta ) )",
  output_range_getter_preconditions := [ [ "Coproduct", 1 ] ],
  with_given_object_position := "both",
  dual_operation := "DirectProductOnObjectAndMorphism",
  dual_arguments_reversed := false,
  compatible_with_congruence_of_morphisms := true,
  # Test in MonoidalCategoriesTest
),

CoproductOnObjectAndMorphismWithGivenCoproducts := rec(
  ...
  output_range_getter_string := "r",
  output_range_getter_preconditions := [ ],
  dual_operation := "DirectProductOnObjectAndMorphismWithGivenDirectProducts",
  dual_with_given_objects_reversed := true,
  compatible_with_congruence_of_morphisms := true,
),
