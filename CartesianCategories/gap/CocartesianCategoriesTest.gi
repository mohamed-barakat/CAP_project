...
InstallGlobalFunction( "CocartesianCategoriesTest",
    function( cat, opposite, a, b, c, alpha, beta )
        ...
        if CanCompute( cat, "CoproductOnMorphismAndObject" ) then
            
            alpha_tensor_id_b := CoproductOnMorphismAndObject( alpha, b );
            beta_tensor_id_a := CoproductOnMorphismAndObject( beta, a );
            
            alpha_tensor_id_b_op := DirectProductOnMorphismAndObject( opposite, alpha_op, b_op );
            beta_tensor_id_a_op := DirectProductOnMorphismAndObject( opposite, beta_op, a_op );
        ...
        if CanCompute( cat, "CoproductOnObjectAndMorphism" ) then
            
            id_b_tensor_alpha := CoproductOnObjectAndMorphism( b, alpha );
            id_a_tensor_beta := CoproductOnObjectAndMorphism( a, beta );
            
            id_b_tensor_alpha_op := DirectProductOnObjectAndMorphism( opposite, b_op, alpha_op );
            id_a_tensor_beta_op := DirectProductOnObjectAndMorphism( opposite, a_op, beta_op );
