...
function ( cat_1, a_1 )
    ...
    morphism_attr_1_1 := ConvertMatrixToRow( deduped_3_1 ) * (KroneckerMat( TransposedMatrix( deduped_3_1 ), deduped_3_1 ) * (KroneckerMat( deduped_3_1, HomalgMatrix( PermutationMat( PermList( [ 1 .. deduped_6_1 ] ), deduped_6_1 ), deduped_6_1, deduped_6_1, deduped_7_1 ) ) * KroneckerMat( HomalgMatrix( PermutationMat( PermList( List( [ 1 .. deduped_4_1 ], function ( i_2 )
                            local deduped_1_2;
                            deduped_1_2 := (i_2 - 1);
...
function ( cat_1, alpha_1 )
    ...
    deduped_4_1 := deduped_5_1 * deduped_5_1;
    deduped_3_1 := HomalgIdentityMatrix( deduped_5_1, deduped_7_1 );
    morphism_attr_1_1 := ConvertMatrixToRow( HomalgIdentityMatrix( Dimension( Source( alpha_1 ) ), deduped_7_1 ) ) * (KroneckerMat( TransposedMatrix( deduped_3_1 ), UnderlyingMatrix( alpha_1 ) ) * (KroneckerMat( deduped_3_1, HomalgMatrix( PermutationMat( PermList( [ 1 .. deduped_5_1 ] ), deduped_5_1 ), deduped_5_1, deduped_5_1, deduped_7_1 ) ) * KroneckerMat( HomalgMatrix( PermutationMat( PermList( List( [ 1 .. deduped_4_1 ], function ( i_2 )
                            local deduped_1_2;
                            deduped_1_2 := (i_2 - 1);
                            return (REM_INT( deduped_1_2, deduped_5_1 ) * deduped_5_1 + QUO_INT( deduped_1_2, deduped_5_1 ) + 1);
                        end ) ), deduped_4_1 ), deduped_4_1, deduped_4_1, deduped_7_1 ), deduped_6_1 ) * KroneckerMat( ConvertMatrixToColumn( deduped_3_1 ), deduped_6_1 )));
...
function ( cat_1, a_1 )
    ...
    morphism_attr_1_1 := KroneckerMat( TransposedMatrix( deduped_2_1 ), deduped_3_1 ) * (KroneckerMat( deduped_2_1, HomalgMatrix( PermutationMat( PermList( [ 1 .. deduped_5_1 ] ), deduped_5_1 ), deduped_5_1, deduped_5_1, deduped_4_1 ) ) * KroneckerMat( HomalgMatrix( PermutationMat( PermList( [ 1 ] ), 1 ), 1, 1, deduped_4_1 ), deduped_3_1 ) * KroneckerMat( ConvertMatrixToColumn( deduped_2_1 ), deduped_3_1 ));
    return CreateCapCategoryMorphismWithAttributes( cat_1, CreateCapCategoryObjectWithAttributes( cat_1, Dimension, NumberRows( morphism_attr_1_1 ) ), CreateCapCategoryObjectWithAttributes( cat_1, Dimension, NumberColumns( morphism_attr_1_1 ) ), UnderlyingMatrix, morphism_attr_1_1 );
end
########
...
function ( cat_1, a_1 )
    ...
    morphism_attr_1_1 := KroneckerMat( deduped_2_1, deduped_3_1 ) * KroneckerMat( HomalgMatrix( PermutationMat( PermList( [ 1 .. deduped_4_1 ] ), deduped_4_1 ), deduped_4_1, deduped_4_1, deduped_5_1 ), deduped_3_1 ) * KroneckerMat( deduped_2_1, ConvertMatrixToColumn( deduped_3_1 ) );
...
function ( cat_1, a_1 )
    ...
    deduped_3_1 := HomalgIdentityMatrix( 1, deduped_5_1 );
    deduped_2_1 := HomalgIdentityMatrix( deduped_4_1, deduped_5_1 );
    morphism_attr_1_1 := KroneckerMat( deduped_2_1, ConvertMatrixToRow( deduped_3_1 ) ) * KroneckerMat( HomalgMatrix( PermutationMat( PermList( [ 1 .. deduped_4_1 ] ), deduped_4_1 ), deduped_4_1, deduped_4_1, deduped_5_1 ), deduped_3_1 ) * KroneckerMat( deduped_2_1, deduped_3_1 );
...
function ( cat_1, a_1 )
    ...
    deduped_3_1 := HomalgIdentityMatrix( deduped_5_1, deduped_4_1 );
    deduped_2_1 := HomalgIdentityMatrix( 1, deduped_4_1 );
    morphism_attr_1_1 := KroneckerMat( ConvertMatrixToRow( deduped_2_1 ), deduped_3_1 ) * KroneckerMat( HomalgMatrix( PermutationMat( PermList( [ 1 ] ), 1 ), 1, 1, deduped_4_1 ), deduped_3_1 ) * KroneckerMat( deduped_2_1, HomalgMatrix( PermutationMat( PermList( [ 1 .. deduped_5_1 ] ), deduped_5_1 ), deduped_5_1, deduped_5_1, deduped_4_1 ) ) * KroneckerMat( TransposedMatrix( deduped_2_1 ), deduped_3_1 );
    return CreateCapCategoryMorphismWithAttributes( cat_1, CreateCapCategoryObjectWithAttributes( cat_1, Dimension, NumberRows( morphism_attr_1_1 ) ), CreateCapCategoryObjectWithAttributes( cat_1, Dimension, NumberColumns( morphism_attr_1_1 ) ), UnderlyingMatrix, morphism_attr_1_1 );
end
########
...
function ( cat_1, a_1 )
    ...
    morphism_attr_1_1 := KroneckerMat( ConvertMatrixToRow( deduped_3_1 ), deduped_4_1 ) * KroneckerMat( HomalgMatrix( PermutationMat( PermList( List( [ 1 .. deduped_5_1 ], function ( i_2 )
                            ...
                            deduped_1_2 := (i_2 - 1);
                            return (REM_INT( deduped_1_2, deduped_6_1 ) * deduped_6_1 + QUO_INT( deduped_1_2, deduped_6_1 ) + 1);
                        end ) ), deduped_5_1 ), deduped_5_1, deduped_5_1, deduped_7_1 ), deduped_4_1 ) * KroneckerMat( deduped_3_1, HomalgMatrix( PermutationMat( PermList( [ 1 .. deduped_6_1 ] ), deduped_6_1 ), deduped_6_1, deduped_6_1, deduped_7_1 ) ) * KroneckerMat( TransposedMatrix( deduped_3_1 ), deduped_3_1 ) * ConvertMatrixToColumn( deduped_3_1 );
    return CreateCapCategoryMorphismWithAttributes( cat_1, CreateCapCategoryObjectWithAttributes( cat_1, Dimension, NumberRows( morphism_attr_1_1 ) ), CreateCapCategoryObjectWithAttributes( cat_1, Dimension, NumberColumns( morphism_attr_1_1 ) ), UnderlyingMatrix, morphism_attr_1_1 );
end
########
...
function ( cat_1, alpha_1 )
    ...
    morphism_attr_1_1 := KroneckerMat( ConvertMatrixToRow( deduped_3_1 ), deduped_6_1 ) * KroneckerMat( HomalgMatrix( PermutationMat( PermList( List( [ 1 .. deduped_4_1 ], function ( i_2 )
                            ...
                            deduped_1_2 := (i_2 - 1);
                            return (REM_INT( deduped_1_2, deduped_5_1 ) * deduped_5_1 + QUO_INT( deduped_1_2, deduped_5_1 ) + 1);
                        end ) ), deduped_4_1 ), deduped_4_1, deduped_4_1, deduped_7_1 ), deduped_6_1 ) * KroneckerMat( deduped_3_1, HomalgMatrix( PermutationMat( PermList( [ 1 .. deduped_5_1 ] ), deduped_5_1 ), deduped_5_1, deduped_5_1, deduped_7_1 ) ) * KroneckerMat( TransposedMatrix( deduped_3_1 ), UnderlyingMatrix( alpha_1 ) ) * ConvertMatrixToColumn( deduped_3_1 );
    return CreateCapCategoryMorphismWithAttributes( cat_1, CreateCapCategoryObjectWithAttributes( cat_1, Dimension, NumberRows( morphism_attr_1_1 ) ), CreateCapCategoryObjectWithAttributes( cat_1, Dimension, NumberColumns( morphism_attr_1_1 ) ), UnderlyingMatrix, morphism_attr_1_1 );
end
########
